...
pickle_in = open('C:/Users/Jisha/pythonproject/DiabetesPrediction_and_FoodRecommendation-main/diabetes/pages/randomForest.pkl', 'rb')
classifier = pickle.load(pickle_in)

# Define the questions and answer options
questions = ["Gender", "Polyuria (Excessive passage of Urine)", "Polydipsia (Excessive thirst)", "Sudden weight loss", "Weakness", "Polyphagia (Feeling of extreme, insatiable hunger)", "Visual blurring", "Itching", "Irritability", "Delayed healing", "Partial paresis (Weakening of a muscle)", "Muscle stiffness", "Alopecia (Hair fall)", "Obesity (Excessive amount of body fat)"]
options = {
    "Gender": ["Male", "Female"],
